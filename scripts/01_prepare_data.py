...
print("Крок 1: Випадкова вибірка (Reservoir Sampling) з усього файлу...")
sampled_lines = []
# Читаємо файл порядово і збираємо випадкові 10 000 рядків
with open(INPUT_FILE, "r", encoding="utf-8") as f:
    for i, line in tqdm(enumerate(f), desc="Сканування всього файлу"):
        if i < MAX_RECORDS:
...
records = []
for line in tqdm(sampled_lines, desc="Обробка JSON"):
    line = line.strip()
    if not line:
        continue
